...
public partial class admin_relatorios_excelDoencasRecuperadas : AcessoRestrito
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=ListaDoençasRecuperadas.xls");
