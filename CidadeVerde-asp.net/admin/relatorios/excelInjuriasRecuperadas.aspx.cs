...
public partial class admin_relatorios_excelInjuriasRecuperadas : AcessoRestrito
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=ListaInjuriasRecuperadas.xls");
