...
public partial class admin_relatorios_excelEspeciesRecomendadas : AcessoRestrito
{
    CidadeVerde cv = new CidadeVerde();
    protected void Page_Load(object sender, EventArgs e)
    {
        GridViewEspecies.DataSource = cv.buscaEspecies().Select("nRecArborizacaoUrbana = 1");
        GridViewEspecies.DataBind();
        Response.Clear();
        Response.Buffer = true;
        Response.ContentType = "application/vnd.ms-excel";
        Response.AddHeader("content-disposition", "attachment;filename=ListaEspeciesRecomandadas.xls");
