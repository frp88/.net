<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="consultaArvoresPorCEP.aspx.cs" Inherits="admin_consultaArvoresPorCEP"
    Title="CV - Consulta da Quantidade de Árvores por um Determinado CEP" %>
        ...
        <div style="background-color: #f5f5f5; margin: -10px -10px -10px -10px;">
            ...
            <div style="float: left; padding-left: 168px; padding-top: 2px;">
                <asp:Label ID="Label2" runat="server" EnableViewState="False" Font-Size="12px" Font-Bold="True"
                    Text="Selecione um CEP: "></asp:Label>
            </div>
            <div style="float: left; padding-left: 10px;">
                <asp:DropDownList ID="ddlCEP" runat="server" CssClass="bordas" DataValueField="sCEP"
                    DataTextField="sCEP" Width="130" AutoPostBack="True" OnSelectedIndexChanged="ddlCEP_SelectedIndexChanged">
                    <asp:ListItem Selected="True" Value="0">Selecione um CEP</asp:ListItem>
                    <asp:ListItem Value="37900000">37900000</asp:ListItem>
                    <asp:ListItem Value="37965000">37965000</asp:ListItem>
                    <asp:ListItem Value="37901502">37901502</asp:ListItem>
                    <asp:ListItem Value="37902408">37902408</asp:ListItem>
                </asp:DropDownList>
            </div>
            <div class="limpaDir">
            </div>
